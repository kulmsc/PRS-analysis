...
allScoresTrain <- trainPhenos[["noncancer"]] #this will change the definition of compName
allScoresTest <- testPhenos[["noncancer"]]
...
allSupportsTrain <- trainPhenos[["icd10"]]
allSupportsTest <- testPhenos[["icd10"]]
