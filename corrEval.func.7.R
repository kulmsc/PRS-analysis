...
thePlot=ggplot(supportCorMat,aes(trait,totalCor))+geom_col()+
...
thePlot=ggplot(supportCorMat)+
  geom_point(aes(trait,totalPval,group=1,color="blue"))+
  geom_point(aes(trait,bottomPval,group=1,color="green"))+
  geom_point(aes(trait,topPval,group=1,color="red"))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),plot.margin = unit(c(0.5,0.5,0.5,2),"cm"))+
  labs(title="Correlation Among Non-Disease Traits",x="Traits",y="Correlation PVal",color="quartiles")+
...
thePlot=ggplot(diseasetCorMat,aes(trait,totalCor))+geom_col()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),plot.margin = unit(c(0.5,0.5,0.5,2),"cm"))+
...
thePlot=ggplot(diseaseCorMat)+
  ...
  geom_point(aes(trait,topPval,group=1,color="red"))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1),plot.margin = unit(c(0.5,0.5,0.5,2),"cm"))+
  labs(title="Correlation Among Disease Traits",x="Traits",y="Correlation PVal",color="quartiles")+
  scale_color_manual(labels = c("total","bottom","top"), values = c("blue","red","green"))
plot(thePlot)
...
makePlotsColor(allResSupports,allScoresTrain,8,3)
